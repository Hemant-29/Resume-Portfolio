            ...
            <div className="main-body">
                <div className="main-body-relative">
                    ...
                    <div className='project-container'>
                        <ProjectsCard name="Microsoft Clone" image={MicrosoftImage} website="https://github.com/Hemant-29/Project-Microsoft-Page" tech="HTML, CSS, Javascript, React.js" aboutText="This is the landing page of the Microsoft that I created using HTML, CSS, Javascript. It has complete frontEnd functionality as the original page."></ProjectsCard>
